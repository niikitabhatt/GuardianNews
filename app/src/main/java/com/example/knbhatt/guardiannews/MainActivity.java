package com.example.knbhatt.guardiannews;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<News>> ,
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
       ...
       String section = sharedPrefs.getString(
                ...
                getString(R.string.settings_interest_default));

            mUrlRequestGuardianApi = "http://content.guardianapis.com/search?q=android&section=" + section + "&order-by=newest&order-date=published&show-section=true&show-fields=headline,thumbnail&show-references=author&show-tags=contributor&page=1&page-size=" + pageNumber + "&api-key=f5487753-c4e4-4992-8130-1da8b83c9bca";
